...
tf.flags.DEFINE_string('X', 'data/tfrecords/print.tfrecords',
                       'X tfrecords file for training, default: data/tfrecords/print.tfrecords')
tf.flags.DEFINE_string('Y', 'data/tfrecords/hw.tfrecords',
                       'Y tfrecords file for training, default: data/tfrecords/hw.tfrecords')
