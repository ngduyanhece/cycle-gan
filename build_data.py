...
tf.flags.DEFINE_string('X_input_dir', 'data/print2hw/trainA',
                       'X input directory, default: data/print2hw/trainA')
tf.flags.DEFINE_string('Y_input_dir', 'data/print2hw/trainB',
                       'Y input directory, default: data/print2hw/trainB')
tf.flags.DEFINE_string('X_output_file', 'data/tfrecords/print.tfrecords',
                       'X output tfrecords file, default: data/tfrecords/print.tfrecords')
tf.flags.DEFINE_string('Y_output_file', 'data/tfrecords/hw.tfrecords',
                       'Y output tfrecords file, default: data/tfrecords/hw.tfrecords')
...
def data_reader(input_dir, shuffle=True):
  ...
  for img_file in scandir(input_dir):
    if img_file.name.endswith('.png') or img_file.name.endswith('.jpg') and img_file.is_file():
